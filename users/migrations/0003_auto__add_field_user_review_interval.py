...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.review_interval'
        db.add_column(u'users_user', 'review_interval',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.review_interval'
        db.delete_column(u'users_user', 'review_interval')
