...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.test_items_limit'
        db.add_column(u'users_user', 'test_items_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.test_items_limit'
        db.delete_column(u'users_user', 'test_items_limit')
